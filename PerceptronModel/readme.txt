Overview:
In this assignment, the following perceptron classifiers (vanilla and averaged) were implemented to identify hotel reviews as either true or fake, and either positive or negative. The word tokens as features, or any other features can be devised from the text.
...
Programs:
Two programs: perceplearn.py will learn perceptron models (vanilla and averaged) from the training data, and percepclassify.py will use the models to classify new data.
