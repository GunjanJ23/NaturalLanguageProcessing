Overview:
In this assignment, the following perceptron classifiers (vanilla and averaged) were implemented to identify hotel reviews as either true or fake, and either positive or negative. 
